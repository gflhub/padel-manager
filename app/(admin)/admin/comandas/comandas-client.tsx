...
import { createComanda, addComandaItem, closeComanda, getComandaWithItems } from "@/app/actions/comandas"
            ...
            <Tabs defaultValue="open">
                ...
                <TabsContent value="open">
                    <Card><CardContent className="pt-6">
                        <Table>
                            <TableHeader><TableRow><TableHead>Cliente</TableHead><TableHead>Itens</TableHead><TableHead>Total</TableHead><TableHead>Desde</TableHead><TableHead className="text-right">Ações</TableHead></TableRow></TableHeader>
                            <TableBody>
                                {openComandas.length === 0 ? (
                                    <TableRow><TableCell colSpan={5} className="text-center text-muted-foreground py-8">Nenhuma comanda aberta.</TableCell></TableRow>
                                ) : openComandas.map(c => (
                                    <TableRow key={c.id}>
